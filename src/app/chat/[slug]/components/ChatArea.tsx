...
interface ChatAreaProps {
  ...
  onEscalationClick: (escalationData?: {
    type: "new" | "continue" | "form";
    caseId?: string;
    sessionId?: string;
  }) => void;
  disabled: boolean;
                ...
                <div className="flex flex-col items-center justify-center min-h-[400px] py-12 space-y-8">
                  <div className="flex flex-col items-center">
                    ...
                    <span className="text-slate-600 dark:text-slate-400 text-center max-w-md leading-relaxed">
                      Please wait while we find an available agent to assist
                      you. This usually takes just a moment.
                    </span>
                  </div>
                        ...
                        <div className="flex items-start gap-4 mb-6">
                          ...
                          <div className="flex-1">
                            ...
                            <p className="text-emerald-800 dark:text-emerald-200 text-sm leading-relaxed">
                              Your ticket has been submitted successfully and
                              you're in the queue
                            </p>
                          </div>
                        </div>
                          ...
                          <div className="flex items-center justify-between p-4 bg-card  rounded-lg border-emerald-200 dark:border-emerald-800">
                            ...
                            <div className="flex items-center gap-3">
                              ...
                              <Button
                                ...
                                onClick={() =>
                                  copyToClipboard(escalationResponse.caseNumber)
                                }
                              >
                                {copiedToClipboard ? (
                          ...
                          <div className="space-y-3 text-sm text-emerald-800 dark:text-emerald-200">
                            <div className="flex items-center gap-3">
                              ...
                              <span>
                                Submitted:{" "}
                                {format(
                                  new Date(escalationResponse.createdAt),
                                  "MMM dd, HH:mm"
                                )}
                              </span>
                            </div>
                    ...
                    <div className="flex flex-col items-center justify-center min-h-[400px] py-12">
                      <div className="flex flex-col items-center text-center">
                        ...
                        <span className="text-slate-600 dark:text-slate-400 text-center max-w-md leading-relaxed">
                          ...
                          you may have. Feel free to ask me anything!
                        </span>
                      </div>
                    </div>
                  ) : (
                ...
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <div className="bg-slate-200 dark:bg-slate-800 rounded-2xl rounded-tl-sm px-4 py-3">
                    <div className="flex gap-1">
                      ...
                      <div
                        className="w-2 h-2 bg-slate-500 dark:bg-slate-500 rounded-full animate-bounce"
