...
interface CreateAgentErrors extends Partial<CreateAgentData> {
  server?: string;
}
...
export function CreateAgentDialog({
  ...
  const [formData, setFormData] = React.useState<CreateAgentData>({
    name: "",
    email: "",
    phone: "",
    password: "",
  ...
  const [errors, setErrors] = React.useState<CreateAgentErrors>({});
  ...
  const validateForm = (): boolean => {
    const newErrors: CreateAgentErrors = {};
