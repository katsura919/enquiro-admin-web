    ...
    items: [
      ...
      { name: "Cases", href: "/dashboard/escalations", icon: Inbox },
      {
        ...
        children: [
          ...
          {
            name: "Services",
            href: "/dashboard/knowledge/services",
            icon: Wrench,
          },
          {
            name: "Policy",
            href: "/dashboard/knowledge/policy",
            icon: FileText,
          },
    ...
    items: [
      {
        ...
        href: "/dashboard/realtime-dashboard",
        icon: Monitor,
      },
      {
  ...
  useEffect(() => {
    if (pathname.startsWith("/dashboard/knowledge/")) {
      setExpandedItems((prev) =>
        prev.includes("Knowledge Base") ? prev : [...prev, "Knowledge Base"]
      );
    }
  }, [pathname]);
        ...
        <div className="min-h-screen ">
          ...
          <main
            className={cn(
              ...
              isSidebarOpen ? "lg:pl-60" : "lg:pl-20 pl-0"
            )}
          >
