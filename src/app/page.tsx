                ...
                <div className="flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-16">
                  ...
                  <div className="flex flex-col space-y-8 lg:w-1/2">
                    <div className="space-y-6">
                      {/* Badge */}
                      <div className="inline-flex items-center px-4 py-2 rounded-full bg-gradient-to-r from-slate-500/20 to-indigo-500/20 border border-slate-500/30 backdrop-blur-sm w-fit">
                        <Users className="w-4 h-4 text-slate-300 mr-2" />
                    ...
                    <div className="space-y-4">
                      <div className="flex items-center space-x-4 p-3 rounded-lg bg-slate-500/10 border border-slate-500/20 backdrop-blur-sm">
                  ...
                  <div className="lg:w-1/2 flex justify-center">
                    <div className="relative w-full max-w-lg">
                      ...
                      <div className="absolute inset-0 bg-gradient-to-r from-slate-500 to-indigo-600 rounded-3xl blur-3xl opacity-20"></div>
                      <div className="absolute inset-2 bg-gradient-to-r from-slate-400 to-blue-500 rounded-3xl blur-2xl opacity-15"></div>

                      {/* Main Card */}
                      <div className="relative p-8 lg:p-10 rounded-3xl bg-gradient-to-b from-slate-800/40 via-slate-800/20 to-slate-900/10 backdrop-blur-lg border border-slate-600/30 shadow-2xl">
                        {/* Header */}
                        ...
                        <h3 className="text-2xl font-bold mb-4 text-slate-100 text-center">
                        ...
                        {/* Stats Grid */}
                        <div className="grid grid-cols-3 gap-6 pt-6 border-t border-slate-600/20">
